...
class ColorSTR extends AbstractColor
{
    ...
    {
        return array_keys(self::$webColorStrToHexMap);
    }
    ...
    {
        preg_match("/^#([A-Fa-f0-9]{1,2})([A-Fa-f0-9]{1,2})([A-Fa-f0-9]{1,2})/i", $this->getColorHexaCode(), $matches);

        return new ColorRGBHexadecimal($matches[1], $matches[2], $matches[3]);
    }
    ...
    {
        $trans = array_flip(self::$webColorStrToHexMap);

        return isset($trans[$hex]) ? $trans[$hex] : null;
    }
